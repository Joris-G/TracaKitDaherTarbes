...
<div class ='title2' id='title'>Choix de l'outillage</div>
...
<?php
            ...
            ?>
    <select id="programs" class='programs' name='programs' data-target='#tool' data-source='/TracaKitDaherTarbes/scriptPhp/toolList.php?types=tool&filter=$prog'>
